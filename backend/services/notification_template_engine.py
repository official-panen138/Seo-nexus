...
class NotificationTemplateCRUD:
    ...
    async def preview_template(
        ...
        sample_context = build_notification_context(
            ...
            node={
                "domain_name": "example.com/blog/article", 
                "full_path": "/blog/article", 
                "domain_role": "Supporting / Tier 2", 
                "tier": "Tier 2", 
                "domain_status": "301 Redirect",
            ...
            impact={"severity": "HIGH", "description": "Affects tier 1-2 nodes", "affected_count": 2, "affected_children": "  • child1.com/page\n  • child2.com/page"},
            structure={
                "current": "LP / Money Site:\n  • moneysite.com [Primary]\nTier 1:\n  • tier1.com [301 Redirect] → moneysite.com", 
                "upstream_chain": "example.com → tier1.com → moneysite.com", 
                "downstream_impact": "3 nodes affected",
                "before_deletion": "   💰 moneysite.com [Primary]\n   🔗 tier1.com [301 Redirect]\n🗑️ 🔗 example.com/blog/article [301 Redirect]\n   🔗 child1.com [Canonical]",
                "chain": "🗑️ example.com/blog/article [301 Redirect]\n   → tier1.com [Supporting / Tier 2]\n   → 💰 moneysite.com [LP / Money Site]\n   → END: 💰 MONEY SITE",
            },
