...
class TestMonitoringSettings:
    ...
    def test_get_monitoring_settings(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v3/monitoring/settings", headers=headers)
        assert response.status_code == 200
    ...
    def test_update_monitoring_settings(self, headers):
        ...
        get_response = requests.get(f"{BASE_URL}/api/v3/monitoring/settings", headers=headers)
        ...
        verify_response = requests.get(f"{BASE_URL}/api/v3/monitoring/settings", headers=headers)
...
class TestExpirationMonitoring:
    ...
    def test_trigger_expiration_check(self, headers):
        ...
        response = requests.post(f"{BASE_URL}/api/v3/monitoring/check-expiration", headers=headers)
        assert response.status_code == 200
    ...
    def test_get_expiring_domains(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v3/monitoring/expiring-domains?days=30", headers=headers)
        assert response.status_code == 200
...
class TestAvailabilityMonitoring:
    ...
    def test_trigger_availability_check(self, headers):
        ...
        response = requests.post(f"{BASE_URL}/api/v3/monitoring/check-availability", headers=headers)
        assert response.status_code == 200
    ...
    def test_get_down_domains(self, headers):
        ...
        response = requests.get(f"{BASE_URL}/api/v3/monitoring/down-domains", headers=headers)
        assert response.status_code == 200
...
class TestMonitoringFieldsInAssetDomain:
    ...
    def test_asset_domain_has_new_monitoring_fields(self, headers):
        ...
        if domains:
            ...
            assert "monitoring_enabled" in domain or domain.get("monitoring_enabled") is not None or domain.get("monitoring_enabled") is False
            assert "monitoring_interval" in domain or domain.get("monitoring_interval") is not None
