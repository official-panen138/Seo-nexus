        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <div 
                    ...
                    data-testid="online-users-trigger"
                >
            ...
            <PopoverContent 
                className="w-72 p-0 bg-zinc-900 border-border"
                align="start"
                side="right"
            >
                                    ...
                                    <TooltipProvider key={u.user_id}>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-zinc-800">
                                                    <div className="relative">
                                            ...
                                            <TooltipContent side="right">
                                                <p>Last seen: {formatLastSeen(u.last_seen)}</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                                ))}
